...
const HeroTestimonial:FC<Testimonial> = ({users, reviews, rating}) => {
  return (
    <div className={style.testimonial}>
      ...
      <div className={style.testimonial_item}>
        ...
        <span className={style.testimonial_text}>{users}+ users</span>
      </div>
      ...
      <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className={style.testimonial_text}>{reviews}+ reviews</span>
      </div>
      ...
      <div className={style.testimonial_item}>
        ...
        <span className={style.testimonial_text}>{rating} rating</span>
      </div>
