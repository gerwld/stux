  ...
  return (
    <div className={clsx(style.stats, isMobile ? style.stats_mobile : style.stats_desktop)}>
      ...
      <div className={style.stats_item}>
        ...
        <span className={style.stats_text}>{users}+ <span>users</span></span>
      </div>
      ...
      <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span className={style.stats_text}>{reviews}+ <span>reviews</span></span>
      </div>
      ...
      <div className={style.stats_item}>
        ...
        <span className={style.stats_text}>{rating} <span>rating</span></span>
      </div>
